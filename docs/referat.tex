...
\begin{infobox}[Diagrama arhitecturala interactiva]
In repository-ul proiectului (\texttt{prognoza-meteo-architecture.html}) exista o diagrama arhitecturala interactiva in format HTML care prezinta vizual toate straturile aplicatiei, procedurile stocate si fluxurile de date. Aceasta poate fi deschisa in orice browser modern si ofera o perspectiva complementara diagramei statice din prezentul referat.
\end{infobox}
